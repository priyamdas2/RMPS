...
RcppExport SEXP _RMPSH_update_x(SEXP xSEXP, SEXP epsilonSEXP, SEXP rhoSEXP, SEXP phiSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(update_x(x, epsilon, rho, phi));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_RMPSH_update_x", (DL_FUNC) &_RMPSH_update_x, 4},
    {NULL, NULL, 0}
};
