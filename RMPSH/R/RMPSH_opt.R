...
#' @examples
#' g <- function(y)
#' return(-20 * exp(-0.2 * sqrt(0.5 * (y[1] ^ 2 + y[2] ^ 2))) - exp(0.5 * (cos(2 * pi * y[1]) + cos(2 * pi * y[2]))) + exp(1) + 20)
#'
...
Rcpp::sourceCpp('C:/Users/priya/Desktop/RMPSH/R/src/anti_transformation.cpp')
Rcpp::sourceCpp('C:/Users/priya/Desktop/RMPSH/R/src/transformation.cpp')
Rcpp::sourceCpp('C:/Users/priya/Desktop/RMPSH/R/src/update_x.cpp')
...
# x0 = c(1,1);lb = c(-3,-3);ub = c(3,3)
# g <- function(y){return(-20 * exp(-0.2 * sqrt(0.5 * (y[1] ^ 2 + y[2] ^ 2))) - exp(0.5 * (cos(2 * pi * y[1]) + cos(2 * pi * y[2]))) + exp(1) + 20)}
# RMPSH_opt(x0,g,lb,ub)
